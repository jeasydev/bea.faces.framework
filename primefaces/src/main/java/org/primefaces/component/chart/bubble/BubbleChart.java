...
public class BubbleChart extends UIChart implements org.primefaces.component.api.Widget {
    ...
    public BubbleChart() {
        setRendererType(BubbleChart.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return BubbleChart.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(BubbleChart.OPTIMIZED_PACKAGE)) {
    ...
    public void setBubbleAlpha(final double _bubbleAlpha) {
        getStateHelper().put(PropertyKeys.bubbleAlpha, _bubbleAlpha);
        handleAttribute("bubbleAlpha", _bubbleAlpha);
    }

    public void setBubbleGradients(final boolean _bubbleGradients) {
    ...
    public void setShowLabels(final boolean _showLabels) {
        getStateHelper().put(PropertyKeys.showLabels, _showLabels);
        handleAttribute("showLabels", _showLabels);
    }

    public void setValue(final org.primefaces.model.chart.BubbleChartModel _value) {
