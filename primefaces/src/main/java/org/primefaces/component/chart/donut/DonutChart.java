...
public class DonutChart extends UIChart implements org.primefaces.component.api.Widget {
    ...
    public DonutChart() {
        setRendererType(DonutChart.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return DonutChart.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(DonutChart.OPTIMIZED_PACKAGE)) {
    ...
    public void setValue(final org.primefaces.model.chart.DonutChartModel _value) {
