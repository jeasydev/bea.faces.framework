...
public class SelectOneListboxRenderer extends SelectOneRenderer {
    ...
    public void encodeEnd(final FacesContext context, final UIComponent component) throws IOException {
        final SelectOneListbox listbox = (SelectOneListbox) component;
    ...
    protected void encodeInput(final FacesContext context,
                               final SelectOneListbox listbox,
    ...
    protected void encodeItem(final FacesContext context,
                              ...
                              final boolean customContent) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String itemValueAsString = getOptionAsString(context, listbox, converter, option.getValue());
        final boolean disabled = option.isDisabled() || listbox.isDisabled();
        ...
        final boolean selected = isSelected(context, listbox, itemValue, valuesArray, converter);
        ...
        if (customContent) {
            final String var = listbox.getVar();
            ...
            for (final UIComponent child : listbox.getChildren()) {
    ...
    protected void encodeList(final FacesContext context,
                              ...
                              final List<SelectItem> selectItems) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final Converter converter = listbox.getConverter();
        final Object values = getValues(listbox);
        final Object submittedValues = getSubmittedValues(listbox);
        final boolean customContent = listbox.getVar() != null;
    ...
    protected void encodeMarkup(final FacesContext context, final SelectOneListbox listbox) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String clientId = listbox.getClientId(context);
        final List<SelectItem> selectItems = getSelectItems(context, listbox);

        final String style = listbox.getStyle();
        String styleClass = listbox.getStyleClass();
        styleClass = styleClass == null ? SelectOneListbox.CONTAINER_CLASS : SelectOneListbox.CONTAINER_CLASS + " "
            + styleClass;
    ...
    protected void encodeScript(final FacesContext context, final SelectOneListbox listbox) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String clientId = listbox.getClientId(context);
        final WidgetBuilder wb = getWidgetBuilder(context);
        wb.widget("SelectOneListbox", listbox.resolveWidgetVar(), clientId, false).attr("disabled",
    ...
    public Object getConvertedValue(final FacesContext context, final UIComponent component, final Object submittedValue)
        ...
        return context.getRenderKit().getRenderer("javax.faces.SelectOne", "javax.faces.Listbox")
