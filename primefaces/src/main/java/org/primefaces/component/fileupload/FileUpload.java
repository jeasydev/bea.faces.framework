...
@ResourceDependencies({ @ResourceDependency(library = "primefaces", name = "primefaces.css"), @ResourceDependency(library = "primefaces", name = "fileupload/fileupload.css"), @ResourceDependency(library = "primefaces", name = "jquery/jquery.js"), @ResourceDependency(library = "primefaces", name = "jquery/jquery-plugins.js"), @ResourceDependency(library = "primefaces", name = "primefaces.js"), @ResourceDependency(library = "primefaces", name = "fileupload/fileupload.js") })
public class FileUpload extends UIInput implements org.primefaces.component.api.Widget {
    ...
    public FileUpload() {
        setRendererType(FileUpload.DEFAULT_RENDERER);
    }
    ...
    public void broadcast(final javax.faces.event.FacesEvent event) throws javax.faces.event.AbortProcessingException {
        ...
        final MethodExpression me = getFileUploadListener();
    ...
    public String getFamily() {
        return FileUpload.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(FileUpload.OPTIMIZED_PACKAGE)) {
    ...
    public void setAllowTypes(final java.lang.String _allowTypes) {
        getStateHelper().put(PropertyKeys.allowTypes, _allowTypes);
        handleAttribute("allowTypes", _allowTypes);
    }

    public void setAuto(final boolean _auto) {
    ...
    public void setDragDropSupport(final boolean _dragDropSupport) {
        getStateHelper().put(PropertyKeys.dragDropSupport, _dragDropSupport);
        handleAttribute("dragDropSupport", _dragDropSupport);
    }

    public void setFileUploadListener(final javax.el.MethodExpression _fileUploadListener) {
    ...
    public void setInvalidFileMessage(final java.lang.String _invalidFileMessage) {
    ...
    public void setInvalidSizeMessage(final java.lang.String _invalidSizeMessage) {
    ...
    public void setShowButtons(final boolean _showButtons) {
        getStateHelper().put(PropertyKeys.showButtons, _showButtons);
        handleAttribute("showButtons", _showButtons);
    }

    public void setSizeLimit(final int _sizeLimit) {
    ...
    public void setUploadLabel(final java.lang.String _uploadLabel) {
