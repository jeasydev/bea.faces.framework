...
public class AccordionPanel extends UIData implements org.primefaces.component.api.Widget,
    ...
    private static final Collection<String> EVENT_NAMES = Collections.unmodifiableCollection(Arrays
        .asList(AccordionPanel.DEFAULT_EVENT));

    List<Tab> loadedTabs;

    public AccordionPanel() {
        setRendererType(AccordionPanel.DEFAULT_RENDERER);
    }
    ...
    public String getDefaultEventName() {
        return AccordionPanel.DEFAULT_EVENT;
    }
    ...
    public Collection<String> getEventNames() {
        return AccordionPanel.EVENT_NAMES;
    }
    ...
    public String getFamily() {
        return AccordionPanel.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(AccordionPanel.OPTIMIZED_PACKAGE)) {
    ...
    public void setActiveIndex(final java.lang.String _activeIndex) {
