...
public class TerminalHandler extends ComponentHandler {
    ...
    public TerminalHandler(final ComponentConfig config) {
        super(config);
    }
    ...
    protected MetaRuleset createMetaRuleset(final Class type) {
        ...
        final Class[] paramList = new Class[] { String.class, String[].class };

        final MetaRule metaRule = new MethodRule("commandHandler", String.class, paramList);
