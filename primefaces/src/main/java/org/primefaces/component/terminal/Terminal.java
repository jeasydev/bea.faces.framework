...
@ResourceDependencies({ @ResourceDependency(library = "primefaces", name = "terminal/terminal.css"), @ResourceDependency(library = "primefaces", name = "jquery/jquery.js"), @ResourceDependency(library = "primefaces", name = "primefaces.js"), @ResourceDependency(library = "primefaces", name = "terminal/terminal.js") })
public class Terminal extends UIComponentBase implements org.primefaces.component.api.Widget {
    ...
    public Terminal() {
        setRendererType(Terminal.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return Terminal.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(Terminal.OPTIMIZED_PACKAGE)) {
    ...
    public void setCommandHandler(final javax.el.MethodExpression _commandHandler) {
    ...
    public void setPrompt(final java.lang.String _prompt) {
        getStateHelper().put(PropertyKeys.prompt, _prompt);
        handleAttribute("prompt", _prompt);
    }

    public void setWelcomeMessage(final java.lang.String _welcomeMessage) {
