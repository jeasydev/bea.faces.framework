...
public class SocketRenderer extends CoreRenderer {
    ...
    public void encodeEnd(final FacesContext context, final UIComponent component) throws IOException {
        ...
        final Socket socket = (Socket) component;
        final String channel = socket.getChannel();
        final String channelUrl = Constants.PUSH_PATH + channel;
        String url = getResourceURL(context, channelUrl);
        final String pushServer = context.getExternalContext().getInitParameter(Constants.PUSH_SERVER_URL);
