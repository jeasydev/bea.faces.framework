...
public class SelectOneButton extends UISelectOne implements org.primefaces.component.api.Widget,
    ...
    private static final Collection<String> EVENT_NAMES = Collections.unmodifiableCollection(Arrays
        .asList(SelectOneButton.DEFAULT_EVENT));

    public SelectOneButton() {
        setRendererType(SelectOneButton.DEFAULT_RENDERER);
    }

    @Override
    public String getDefaultEventName() {
        return SelectOneButton.DEFAULT_EVENT;
    }

    @Override
    public Collection<String> getEventNames() {
        return SelectOneButton.EVENT_NAMES;
    }
    ...
    public String getFamily() {
        return SelectOneButton.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(SelectOneButton.OPTIMIZED_PACKAGE)) {
