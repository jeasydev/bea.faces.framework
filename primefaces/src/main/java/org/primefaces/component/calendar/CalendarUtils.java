...
public class CalendarUtils {
    ...
    public static String convertPattern(String pattern) {
        if (pattern == null)
            ...
            else pattern = pattern.replaceAll("M", "m");
    ...
    public static String getTimeOnlyValueAsString(final FacesContext context, final Calendar calendar) {
        ...
        if (value instanceof String) {
            ...
            final SimpleDateFormat format = new SimpleDateFormat(calendar.calculateTimeOnlyPattern(), calendar
    ...
    public static String getValueAsString(final FacesContext context, final Calendar calendar) {
        ...
        if (value == null) {
            ...
            // Use built-in converter
                ...
                final SimpleDateFormat dateFormat = new SimpleDateFormat(calendar.calculatePattern(), calendar
                    .calculateLocale(context));
    ...
    public static String getValueAsString(final FacesContext context, final Calendar calendar, final Object value) {
        if (value == null) {
            return null;
        }
