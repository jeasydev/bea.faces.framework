...
@ResourceDependencies({ @ResourceDependency(library = "primefaces", name = "primefaces.css"), @ResourceDependency(library = "primefaces", name = "colorpicker/colorpicker.css"), @ResourceDependency(library = "primefaces", name = "jquery/jquery.js"), @ResourceDependency(library = "primefaces", name = "primefaces.js"), @ResourceDependency(library = "primefaces", name = "colorpicker/colorpicker.js") })
public class ColorPicker extends UIInput implements org.primefaces.component.api.Widget {
    ...
    public ColorPicker() {
        setRendererType(ColorPicker.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return ColorPicker.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(ColorPicker.OPTIMIZED_PACKAGE)) {
