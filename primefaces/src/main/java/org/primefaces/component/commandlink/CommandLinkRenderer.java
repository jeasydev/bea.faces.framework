...
public class CommandLinkRenderer extends CoreRenderer {
    ...
    public void decode(final FacesContext context, final UIComponent component) {
        final CommandLink link = (CommandLink) component;
        if (link.isDisabled()) {
            return;
        }

        final String param = component.getClientId();
    ...
    public void encodeEnd(final FacesContext context, final UIComponent component) throws IOException {
        ...
        final CommandLink link = (CommandLink) component;
        final String clientId = link.getClientId(context);
        final Object label = link.getValue();
        ...
        if (!link.isDisabled()) {
            ...
            if (link.isAjax()) {
                ...
                final UIComponent form = ComponentUtils.findParentForm(context, link);
                if (form == null) {
            ...
            final String onclick = link.getOnclick() != null ? link.getOnclick() + ";" + request : request;
            ...
            String styleClass = link.getStyleClass();
            styleClass = styleClass == null ? CommandLink.DISABLED_STYLE_CLASS : CommandLink.DISABLED_STYLE_CLASS + " "
                + styleClass;
