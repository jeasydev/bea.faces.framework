...
public class LayoutUnitRenderer extends CoreRenderer {
    ...
    public void encodeEnd(final FacesContext context, final UIComponent component) throws IOException {
        ...
        final LayoutUnit unit = (LayoutUnit) component;
        final boolean nesting = unit.isNesting();

        final String defaultStyleClass = Layout.UNIT_CLASS + " ui-layout-" + unit.getPosition();
    ...
    public void encodeFooter(final FacesContext context, final LayoutUnit unit) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
    ...
    public void encodeHeader(final FacesContext context, final LayoutUnit unit) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final Layout layout = (Layout) unit.getParent();
    ...
    protected void encodeIcon(final FacesContext context, final String iconClass, final String title)
        throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
