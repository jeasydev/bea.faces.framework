...
public class PanelMenuRenderer extends BaseMenuRenderer {
    ...
    protected void encodeDescendantSubmenu(final FacesContext context, final Submenu submenu) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String icon = submenu.getIcon();
        final String style = submenu.getStyle();
        String styleClass = submenu.getStyleClass();
        styleClass = styleClass == null ? PanelMenu.DESCENDANT_SUBMENU_CLASS : PanelMenu.DESCENDANT_SUBMENU_CLASS + " "
            + styleClass;
        ...
        for (final UIComponent child : submenu.getChildren()) {
            if (child.isRendered()) {
    ...
    protected void encodeMarkup(final FacesContext context, final AbstractMenu abstractMenu) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final PanelMenu menu = (PanelMenu) abstractMenu;
    ...
    protected void encodeRootSubmenu(final FacesContext context, final PanelMenu menu, final Submenu submenu)
        throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String style = submenu.getStyle();
        String styleClass = submenu.getStyleClass();
