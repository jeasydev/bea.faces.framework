...
public class QuickTimePlayer implements MediaPlayer {
    ...
    private final static String[] supportedTypes = new String[] { "aif", "aiff", "aac", "au", "bmp", "gsm", "mov", "mid", "midi", "mpg", "mpeg", "mp4", "m4a", "psd", "qt", "qtif", "qif", "qti", "snd", "tif", "tiff", "wav", "3g2", "3pg" };
    ...
    public String[] getSupportedTypes() {
        return QuickTimePlayer.supportedTypes;
    }
