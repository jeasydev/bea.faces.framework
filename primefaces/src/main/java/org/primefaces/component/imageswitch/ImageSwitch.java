...
@ResourceDependencies({ @ResourceDependency(library = "primefaces", name = "jquery/jquery.js"), @ResourceDependency(library = "primefaces", name = "primefaces.js"), @ResourceDependency(library = "primefaces", name = "imageswitch/imageswitch.js") })
public class ImageSwitch extends UIComponentBase implements org.primefaces.component.api.Widget {
    ...
    public ImageSwitch() {
        setRendererType(ImageSwitch.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return ImageSwitch.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(ImageSwitch.OPTIMIZED_PACKAGE)) {
    ...
    public void setSlideshowAuto(final boolean _slideshowAuto) {
        getStateHelper().put(PropertyKeys.slideshowAuto, _slideshowAuto);
        handleAttribute("slideshowAuto", _slideshowAuto);
    }

    public void setSlideshowSpeed(final int _slideshowSpeed) {
