...
public class Column extends UIColumn implements org.primefaces.component.api.UIColumn {
    ...
    public CellEditor getCellEditor() {
        if (cellEditor == null) {
            for (final UIComponent child : getChildren()) {
                if (child instanceof CellEditor) cellEditor = (CellEditor) child;
            }
        }
    ...
    public String getFamily() {
        return Column.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(Column.OPTIMIZED_PACKAGE)) {
    ...
    public void setDisabledSelection(final boolean _disabledSelection) {
    ...
    public void setFilterValue(final java.lang.Object _filterValue) {
