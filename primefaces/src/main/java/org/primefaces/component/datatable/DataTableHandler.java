...
public class DataTableHandler extends ComponentHandler {
    ...
    public DataTableHandler(final ComponentConfig config) {
        super(config);
    }
    ...
    protected MetaRuleset createMetaRuleset(final Class type) {
        ...
        final Class[] paramList = new Class[] { Object.class, Object.class };

        final MetaRule metaRule = new MethodRule("sortFunction", Integer.class, paramList);
