...
public class InputMaskRenderer extends InputRenderer {
    ...
    public void decode(final FacesContext context, final UIComponent component) {
        ...
        final String clientId = inputMask.getClientId(context);
    ...
    protected void encodeMarkup(final FacesContext context, final InputMask inputMask) throws IOException {
        ...
        final String valueToRender = ComponentUtils.getValueToRender(context, inputMask);
    ...
    protected void encodeScript(final FacesContext context, final InputMask inputMask) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
        final String clientId = inputMask.getClientId(context);
        ...
        if (mask != null) {
            wb.attr("mask", mask).attr("placeholder", inputMask.getPlaceHolder(), null);
        }
