...
public class InputMask extends HtmlInputText implements org.primefaces.component.api.Widget {
    ...
    public InputMask() {
        setRendererType(InputMask.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return InputMask.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(InputMask.OPTIMIZED_PACKAGE)) {
    ...
    public void setMask(final java.lang.String _mask) {
        getStateHelper().put(PropertyKeys.mask, _mask);
        handleAttribute("mask", _mask);
    }

    public void setPlaceHolder(final java.lang.String _placeHolder) {
