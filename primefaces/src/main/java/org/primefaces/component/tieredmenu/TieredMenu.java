...
public class TieredMenu extends AbstractMenu implements org.primefaces.component.api.Widget,
    ...
    public TieredMenu() {
        setRendererType(TieredMenu.DEFAULT_RENDERER);
    }
    ...
    public String getFamily() {
        return TieredMenu.COMPONENT_FAMILY;
    }
    ...
    public void handleAttribute(final String name, final Object value) {
        ...
        if (setAttributes == null) {
            ...
            if (cname != null && cname.startsWith(TieredMenu.OPTIMIZED_PACKAGE)) {
