...
public class ThemeSwitcherRenderer extends SelectOneMenuRenderer {
    ...
    protected void encodeScript(final FacesContext context, final SelectOneMenu menu) throws IOException {
        ...
        final ThemeSwitcher ts = (ThemeSwitcher) menu;
        final String clientId = ts.getClientId(context);
        final WidgetBuilder wb = getWidgetBuilder(context);
        wb.widget("ThemeSwitcher", ts.resolveWidgetVar(), clientId, true).attr("effect", ts.getEffect(), null)
