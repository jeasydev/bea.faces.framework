...
public class DefaultScheduleModel implements ScheduleModel, Serializable {
    ...
    public DefaultScheduleModel(final List<ScheduleEvent> events) {
        this.events = events;
    }
    ...
    @Override
    public boolean deleteEvent(final ScheduleEvent event) {
    ...
    @Override
    public void updateEvent(final ScheduleEvent event) {
        int index = -1;
