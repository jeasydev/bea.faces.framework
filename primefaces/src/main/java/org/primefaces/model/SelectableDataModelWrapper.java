...
public class SelectableDataModelWrapper extends ListDataModel implements SelectableDataModel {
    ...
    private final SelectableDataModel original;

    public SelectableDataModelWrapper(final SelectableDataModel original, final Object data) {
    ...
    @Override
    public Object getRowKey(final Object object) {
