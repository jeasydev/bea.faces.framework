...
public class DonutChartModel extends ChartModel implements Serializable {
    ...
    public DonutChartModel(final List<Map<String, Number>> data) {
        this.data = data;
    }

    public void addCircle(final Map<String, Number> circle) {
        data.add(circle);
    }
    ...
    public void setData(final List<Map<String, Number>> data) {
        this.data = data;
    }
}