...
public class BeanPropertyComparator implements Comparator {
    ...
    private final ValueExpression sortBy;
    ...
    public BeanPropertyComparator(final ValueExpression sortBy,
                                  final String var,
                                  final SortOrder sortOrder,
                                  final MethodExpression sortFunction) {
        this.sortBy = sortBy;
        this.var = var;
        asc = sortOrder.equals(SortOrder.ASCENDING);
    ...
    public int compare(final Object obj1, final Object obj2) {
        try {
            ...
            final Object value1 = sortBy.getValue(context.getELContext());
            context.getExternalContext().getRequestMap().put(var, obj2);
            final Object value2 = sortBy.getValue(context.getELContext());
            ...
            BeanPropertyComparator.logger.severe("Error in sorting");
