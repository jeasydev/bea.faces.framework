...
public class AutoUpdateComponentListener implements SystemEventListener {
    ...
    @Override
    public boolean isListenerForSource(final Object o) {
        return true;
    }

    @Override
    public void processEvent(final SystemEvent cse) throws AbortProcessingException {
        final AutoUpdatable component = (AutoUpdatable) cse.getSource();
