 ...
 * RequestContext is thread-safe and scope is same as FacesContext. Current
 * instance can be retrieved as; <blockquote>
 * RequestContext.getCurrentInstance(); </blockquote>
 */
