...
public class PrimePartialViewContext extends PartialViewContextWrapper {
    ...
    public PrimePartialViewContext(final PartialViewContext wrapped) {
    ...
    public PartialResponseWriter getPartialResponseWriter() {
        if (writer == null) {
            final PartialResponseWriter parentWriter = getWrapped().getPartialResponseWriter();
    ...
    public boolean isPartialRequest() {
        return getWrapped().isPartialRequest()
            || FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap()
                .containsKey("javax.faces.partial.execute");
    }

    @Override
    public void setPartialRequest(final boolean value) {
