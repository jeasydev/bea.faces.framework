...
public class PrimeResourceHandler extends ResourceHandlerWrapper {
    ...
    public PrimeResourceHandler(final ResourceHandler wrapped) {
    ...
    public void handleResourceRequest(final FacesContext context) throws IOException {
        ...
        final String library = params.get("ln");
        final String dynamicContentId = params.get(Constants.DYNAMIC_CONTENT_PARAM);
        ...
        if (dynamicContentId != null && library != null && library.equals("primefaces")) {
            ...
            try {
                final String dynamicContentEL = (String) session.get(dynamicContentId);
                ...
                PrimeResourceHandler.logger.log(Level.SEVERE, "Error in streaming dynamic resource. {0}",
