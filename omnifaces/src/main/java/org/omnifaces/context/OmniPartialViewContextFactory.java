 ...
 * {@link OmniPartialViewContext} is properly initialized.
 * 
...
public class OmniPartialViewContextFactory extends PartialViewContextFactory {
    ...
    /**
     * Construct a new OmniFaces partial view context factory around the given
     * wrapped factory.
     * 
     * @param wrapped The wrapped factory.
     */
    public OmniPartialViewContextFactory(final PartialViewContextFactory wrapped) {
    ...
    /**
     * Returns a new instance of {@link OmniPartialViewContext} which wraps the
     * original partial view context.
     */
    @Override
