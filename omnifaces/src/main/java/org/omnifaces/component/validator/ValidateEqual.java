...
/**
 * <strong>ValidateEqual</strong> validates if ALL of the given
 * <code>UIInput</code> components have the same value. The default message is
 * <blockquote>{0}: Please fill out the same value for all of those
 * fields</blockquote>
 * <p>
...
public class ValidateEqual extends ValidateMultipleFields {
    ...
    public ValidateEqual() {
        super(ValidateEqual.DEFAULT_MESSAGE);
    }
