...
/**
 * <strong>ValidateOneOrMore</strong> validates if at least ONE of the given
 * <code>UIInput</code> components has been filled out. The default message is
...
public class ValidateOneOrMore extends ValidateMultipleFields {
    ...
    public ValidateOneOrMore() {
        super(ValidateOneOrMore.DEFAULT_MESSAGE);
    }
