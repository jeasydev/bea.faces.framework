...
/**
 * <strong>ValidateAllOrNone</strong> validates if at least ALL of the given
 * <code>UIInput</code> components have been filled out or that NONE of the
 * given <code>UIInput</code> components have been filled out. The default
 * message is <blockquote>{0}: Please fill out all or none of those
 * fields</blockquote>
 * <p>
...
public class ValidateAllOrNone extends ValidateMultipleFields {
    ...
    public ValidateAllOrNone() {
        super(ValidateAllOrNone.DEFAULT_MESSAGE);
    }
    ...
    protected boolean validateValues(final FacesContext context, final List<UIInput> inputs, final List<Object> values) {
        ...
        for (final Object value : values) {
            final boolean currentHasValue = !Utils.isEmpty(value);
