...
/**
 * A value expression implementation that caches its main value at the moment
 * it's evaluated and uses this cache value in future evaluations.
 * 
 * @author Arjan Tijms
 * 
 */
public class CachingValueExpression extends ValueExpressionWrapper {
    ...
    public CachingValueExpression(final String name, final ValueExpression valueExpression, final Cache cache) {
    ...
    public Object getValue(final ELContext elContext) {
        final FacesContext facesContext = Faces.getContext(elContext);
