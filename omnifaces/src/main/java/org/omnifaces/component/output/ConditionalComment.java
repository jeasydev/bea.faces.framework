...
/**
 * <p>
 * <strong>ConditionalComment</strong> is an {@link UIComponent} which renders a
 * conditional comment. Conditional comments are an IE specific feature which
 * enables the developer to (out)comment blocks of HTML depending on whether the
 * client is using IE and if so even which version. They are often seen in
 * combination with CSS stylesheets like so:
 * 
 * <pre>
 * &lt;!--[if lte IE 7]&gt;
 ...
 * <code>javax.faces.FACELETS_SKIP_COMMENTS</code> context param is set to
 * <code>true</code> then it will even not be rendered at all. You would need to
 * workaround this with an ugly <code>&lt;h:outputText escape="false"&gt;</code>.
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Note that you cannot use this with <code>&lt;h:outputStylesheet&gt;</code> as
 * it would implicitly be relocated as direct child of
 * <code>&lt;h:head&gt;</code>.
 * 
...
public class ConditionalComment extends OutputFamily {
    ...
    private enum PropertyKeys {
        ...
        // The below mess is necessary because "if" is a keyword in Java and
        // cannot be used as enum value.
        String toString;
     ...
     * 
     * @throws IllegalArgumentException When <code>if</code> attribute is not
     *             specified.
     */
    @Override
     ...
     */
    public void setIf(final String _if) {
