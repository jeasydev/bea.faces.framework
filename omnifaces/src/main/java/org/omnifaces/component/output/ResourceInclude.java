...
/**
 * This component is used to catch the output from a JSP/Servlet resource and
 * render it as output to the JSF writer. In effect, this allows you to include
 * both Servlets and JSP pages in e.g. Facelets.
 * 
 * @author Arjan Tijms
...
public class ResourceInclude extends OutputFamily {
    ...
    /**
     * Create a dispatcher for the resource given by the component's path
     * attribute, catch its output and write it to the JSF response writer.
     */
    @Override
