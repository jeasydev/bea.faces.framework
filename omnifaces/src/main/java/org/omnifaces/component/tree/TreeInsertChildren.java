...
/**
 * <strong>TreeInsertChildren</strong> is an {@link UIComponent} that represents
 * the insertion point for the children of a parent tree node which is
...
public class TreeInsertChildren extends TreeFamily {
     ...
     * {@link Tree#processTreeNode(FacesContext, PhaseId)}.
     * 
     ...
     *             {@link TreeNodeItem}, or when there are any children.
     */
    @Override
     ...
     * {@link Tree#visitTreeNode(VisitContext, VisitCallback)}.
     * 
