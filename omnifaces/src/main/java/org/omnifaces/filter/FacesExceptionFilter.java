 ...
 * <li>Root cause needs to be unwrapped from FacesException (Mojarra) and
 * ELException (MyFaces) to utilize standard Servlet API error page handling.
 * </ol>
 * <p>
 * To get it to run, map this filter on the <code>&lt;servlet-name&gt;</code> of
 * the <code>FacesServlet</code>.
 * 
 * <pre>
 * &lt;filter&gt;
