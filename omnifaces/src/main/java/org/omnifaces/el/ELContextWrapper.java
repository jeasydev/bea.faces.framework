...
/**
 * <p>
 * Provides a simple implementation of {@link ELContext} that can be sub-classed
 * by developers wishing to provide specialized behavior to an existing
 * {@link ELContext} instance. The default implementation of all methods is to
 * call through to the wrapped {@link ViewHandler}.
 * </p>
 * 
 * <p>
...
public class ELContextWrapper extends ELContext implements FacesWrapper<ELContext> {
    ...
    public ELContextWrapper(final ELContext elContext) {
     ...
     */
    @Override
    public Object getContext(@SuppressWarnings("rawtypes") final Class key) {
     ...
     */
    @Override
    public void putContext(@SuppressWarnings("rawtypes") final Class key, final Object contextObject) {
