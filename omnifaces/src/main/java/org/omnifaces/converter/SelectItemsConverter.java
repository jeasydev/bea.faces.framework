 ...
 * <code>omnifaces.SelectItemsConverter</code>. Basic usage example:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * When extending this converter to override <code>getAsString()</code> to
 * return something simpler, such as the entity ID by
 * <code>return String.valueOf(((Entity) value).getId());</code>, you only have
 * to change the <code>converter</code> attribute in the above example to refer
 * the extended converter instead.
 * 
 * @author Arjan Tijms
 * 
 */
