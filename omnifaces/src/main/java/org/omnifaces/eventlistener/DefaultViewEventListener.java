...
/**
 * Default implementation for the SystemEventListener interface that's used for
 * the subset of system events that are registered as "view event" on the
 * component tree's view root.
 * 
