 ...
 * the builder pattern or a given <code>Map</code>.
 * 
 * @author Arjan Tijms
 */
public class SelectItemsBuilder {
    ...
    /**
     * Builds a <code>List</code> of <code>SelectItem</code>s from the given
     ...
     */
    public static List<SelectItem> fromMap(final Map<?, ?> map) {
        final List<SelectItem> items = new ArrayList<SelectItem>(map.size());
    ...
    public SelectItemsBuilder add(final Object value, final String label) {
