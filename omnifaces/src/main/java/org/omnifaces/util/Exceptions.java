...
public final class Exceptions {
     ...
     * @since 1.4
     */
    public static <T extends Throwable> Throwable unwrap(final Throwable exception) {
        return Exceptions.unwrap(Exceptions.unwrap(exception, FacesException.class), ELException.class);
    }
     ...
     * @return The unwrapped root cause.
     */
    public static <T extends Throwable> Throwable unwrap(Throwable exception, final Class<T> type) {
