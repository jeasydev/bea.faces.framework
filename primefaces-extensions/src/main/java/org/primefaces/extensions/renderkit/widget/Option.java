...
public @interface Option {
    ...
    /**
     * Defines the name of the option. Only required if the default name (name
     * of the property) should not be used.
     * 
    ...
    /**
     * Defines if double quotes instead of a normal quote should be used for
     * rendering {@link String}s.
     * 
