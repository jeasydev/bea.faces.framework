...
public class ConfigContainer {
    ...
    public ConfigContainer(final FacesContext context) {
        ...
        final String deliverUncompressedResourcesStringValue = externalContext
            .getInitParameter(Constants.DELIVER_UNCOMPRESSED_RESOURCES_INIT_PARAM);
        ...
        final String wrapPrimeFacesResourcesStringValue = externalContext
            .getInitParameter(Constants.WRAP_PRIME_FACES_RESOURCES_INIT_PARAM);
