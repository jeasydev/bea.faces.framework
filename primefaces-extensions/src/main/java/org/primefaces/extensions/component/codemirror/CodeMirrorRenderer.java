...
public class CodeMirrorRenderer extends InputRenderer {
    ...
    public void decode(final FacesContext facesContext, final UIComponent component) {
        ...
        if (token != null) {
            ...
            final CompleteEvent autoCompleteEvent = new CompleteEvent(codeMirror, token, context, line, column);
    ...
    protected void encodeMarkup(final FacesContext context, final CodeMirror codeMirror) throws IOException {
        ...
        final String valueToRender = org.primefaces.util.ComponentUtils.getValueToRender(context, codeMirror);
    ...
    protected void encodeScript(final FacesContext context, final CodeMirror codeMirror) throws IOException {
        ...
        if (codeMirror.getProcess() != null) {
            writer.write(",process:'"
                + org.primefaces.util.ComponentUtils.findClientIds(context, codeMirror, codeMirror.getProcess()) + "'");
        }
    ...
    protected void encodeSuggestions(final FacesContext context,
                                     final CodeMirror codeMirror,
                                     final List<String> suggestions) throws IOException {
        final ResponseWriter writer = context.getResponseWriter();
