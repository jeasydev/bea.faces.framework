...
public class TimelineEventsConverter extends JsonConverter {
    ...
    public Object getAsObject(final FacesContext context, final UIComponent component, final String value) {
        ...
        gsonBilder.registerTypeAdapter(Date.class, new DateTypeAdapter(timeZone == null
                                                                                       ? TimeZone.getDefault()
                                                                                       : timeZone));
        gsonBilder.serializeNulls();

        return gsonBilder.create().fromJson(value, getObjectType(TimelineEventsConverter.TYPE_FOR_EVENTS, false));
    }
    ...
    public String getAsString(final FacesContext context, final UIComponent component, final Object value) {
        ...
        return gsonBilder.create().toJson(value, getObjectType(TimelineEventsConverter.TYPE_FOR_EVENTS, false));
    }
